...
const Form = ({ handleSubmitForm, data, countries, isEdit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      if (!isEdit) {
        ...
        handleSubmitForm(); // Call parent function
        ...
        localStorage.setItem(
          "data",
          JSON.stringify([
            ...existingData.filter((each) => each.sn !== formData.sn),
            formData,
          ])
        );
        handleSubmitForm(); // Call parent function
